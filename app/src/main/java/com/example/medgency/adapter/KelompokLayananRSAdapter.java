...
public class KelompokLayananRSAdapter extends RecyclerView.Adapter<KelompokLayananRSAdapter.ViewHolder> {
    private int selectedPos = RecyclerView.NO_POSITION;
    private ArrayList<String> dataList;
    private Context context;
    String email_key_new = "";

    public KelompokLayananRSAdapter(ArrayList<String> dataList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new KelompokLayananRSAdapter.ViewHolder(view);
    }
