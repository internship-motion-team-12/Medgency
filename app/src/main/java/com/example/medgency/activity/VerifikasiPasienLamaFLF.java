...
public class VerifikasiPasienLamaFLF extends AppCompatActivity {
    String email_key_new = "";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_verifikasi_pasien_lama_flf);
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    ETTTL.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            DatePickerDialog datePickerDialog = new DatePickerDialog(VerifikasiPasienLamaFLF.this, new DatePickerDialog.OnDateSetListener() {
                            ...
                            reference2.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    if (!ETNama.getText().toString().isEmpty() && !ETNIK.getText().toString().isEmpty() && !ETAlamat.getText().toString().isEmpty() && dataSnapshot.getValue().toString().equals("1")){
                                        Intent goToPilihJadwal = new Intent(getApplicationContext(),PilihJadwalLamaFLF.class);
                                        Log.d("TAG","From Here");
                                        ...
                                        goToPilihJadwal.putExtra(getString(R.string.PenyediaLayanan),finalPenyediaLayanan);
