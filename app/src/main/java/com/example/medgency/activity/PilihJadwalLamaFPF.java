...
public class PilihJadwalLamaFPF extends AppCompatActivity {
    String email_key = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pilih_jadwal_lama_fpf);
        ...
        RLDiagnosis.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PilihJadwalLamaFPF.this,PilihDiagnosisPB.class);
        ...
        RLTanggalBerobat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(PilihJadwalLamaFPF.this, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                        ...
                        reference.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                RVPilihJadwal.setLayoutManager(new GridLayoutManager(PilihJadwalLamaFPF.this, 3));
                        ...
                        if (JenisLayanan.equals(getString(R.string.RumahSakit))){
                            ...
                            reference1.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    ...
                                    final String NamaRS = dataSnapshot.child("NamaDokter").getValue().toString();
