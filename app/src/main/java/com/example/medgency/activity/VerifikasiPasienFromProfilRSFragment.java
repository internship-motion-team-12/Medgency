...
public class VerifikasiPasienFromProfilRSFragment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verifikasi_pasien_from_profil_rsfragment);
        ...
        RLJenisPasien.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final Dialog dialog = new Dialog(VerifikasiPasienFromProfilRSFragment.this);
                                        ...
                                        reference1.addListenerForSingleValueEvent(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                ...
                                                if (lanjut){ //Nomor Rekam Medis ditemukan di database
                                                    Intent goToVerifikasiPasienLama = new Intent(getApplicationContext(),VerifikasiPasienLamaFPF.class);
                ...
                CVPasienBaru.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        ETTTL.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                DatePickerDialog datePickerDialog = new DatePickerDialog(VerifikasiPasienFromProfilRSFragment.this, new DatePickerDialog.OnDateSetListener() {
                                ...
                                reference1.addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        ...
                                        if (!ETNamaPasienBaru.getText().toString().isEmpty() && !ETNIK.getText().toString().isEmpty() && !ETAlamat.getText().toString().isEmpty() && lanjut){
                                            final Intent goToPilihJadwal = new Intent(getApplicationContext(),PilihJadwalPBFPF.class);
