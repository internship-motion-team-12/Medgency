...
public class VerifikasiPasienLama extends AppCompatActivity {
    String email_key_new = "";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_verifikasi_pasien_lama);
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    ETTTL.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            DatePickerDialog datePickerDialog = new DatePickerDialog(VerifikasiPasienLama.this, new DatePickerDialog.OnDateSetListener() {
