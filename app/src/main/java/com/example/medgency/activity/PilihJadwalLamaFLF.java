...
import com.example.medgency.model.LayananRS;
...
public class PilihJadwalLamaFLF extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pilih_jadwal_lama_flf);

        Log.d("TAG","Di context Pilih Jadwal PBFLF"+getApplicationContext().toString());
        ...
        final String FinalLayanan = before.getStringExtra(getString(R.string.Layanan));
        final String FinalKelompok = before.getStringExtra(getString(R.string.Kelompok));
        ...
        if(jns_layanan[0].equals(getString(R.string.Dokter))){
            ...
            DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child(getString(R.string.Tampungan)).child("users").child(email_key_new).child(getString(R.string.Layanan));
            reference.setValue(before.getStringExtra(getString(R.string.Layanan)));
        }
        ...
        RLTanggalBerobat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(PilihJadwalLamaFLF.this, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                        ...
                        Log.d("TAG", "Penyedia Layanan" + StringFunction.DeleteDotFromString(before.getStringExtra(getString(R.string.PenyediaLayanan))));
                        Log.d("TAG", "Kelompok" + before.getStringExtra(getString(R.string.Kelompok)));
                        DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("JadwalLayananRS").child(StringFunction.DeleteDotFromString(before.getStringExtra(getString(R.string.PenyediaLayanan)))).child(before.getStringExtra(getString(R.string.Kelompok))).child(hari);
                        reference.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                RVPilihJadwal.setLayoutManager(new GridLayoutManager(PilihJadwalLamaFLF.this, 3));
        ...
        BtnToTiketReservasi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                getUsernameLocal();
                final Intent goToTicketReservation = new Intent(getApplicationContext(),TicketReservationPBFLF.class);
                ...
                reference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if (JenisLayanan.equals(getString(R.string.RumahSakit))){
                            goToTicketReservation.putExtra(getString(R.string.PenyediaLayanan),dataSnapshot.child(getString(R.string.JenisLayanan)).getValue().toString());
                            ...
                            goToTicketReservation.putExtra(getString(R.string.Layanan),FinalLayanan);

                            final String WaktuBerobat = dataSnapshot.child(getString(R.string.WaktuBerobat)).getValue().toString();
                            final String Layanan = FinalLayanan;
                            final String Tanggal = dataSnapshot.child(getString(R.string.Tanggal)).getValue().toString();
                            Log.d("TAG","Final Layanan:" + FinalLayanan);

                            DatabaseReference reference1 = FirebaseDatabase.getInstance().getReference().child("LayananRS").child(StringFunction.DeleteDotFromString(finalPenyedia_layanan)).child(FinalLayanan);
                            reference1.addListenerForSingleValueEvent(new ValueEventListener() {
                                @Override
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    LayananRS layananRS = dataSnapshot.getValue(LayananRS.class);
                                    String harga = layananRS.getHarga();
                                    ...
                                    Ticket ticket = new Ticket(Layanan,finalPenyedia_layanan,harga,Tanggal,WaktuBerobat,IdTicket);
