...
public class VerifikasiPasienFromLayananFragment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verifikasi_pasien_from_layanan_fragment);

        Log.d("TAG","Di context VerifikasiPasienFromLayananFragment");
        ...
        if (getIntent().getExtras() != null){
            ...
            layanan = before.getStringExtra(getString(R.string.Layanan));
            kelompok = before.getStringExtra(getString(R.string.Kelompok));
            getUsernameLocal();
            DatabaseReference reference1 = FirebaseDatabase.getInstance().getReference().child(getString(R.string.Tampungan)).child("users").child(email_key_new).child(getString(R.string.JenisLayanan));
            ...
            if (jns_layanan.equals(getString(R.string.RumahSakit))){ // jika jenis layanannya adalah rumah sakit
                ...
                penyedia_layanan =   before.getStringExtra(getString(R.string.PenyediaLayanan));
            }
        ...
        final String FinalLayanan = layanan;

        final String FinalKelompok = kelompok;
        ...
        RLJenisPasien.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final Dialog dialog = new Dialog(VerifikasiPasienFromLayananFragment.this);
                            ...
                            BtnGoToVerifikasiPasienLama.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    if (!ETNomorRekamMedis[0].getText().toString().isEmpty()){ //Edit Text Nomor Rekam Medis terisi
                                        ...
                                        reference1 = FirebaseDatabase.getInstance().getReference().child(getString(R.string.NomorRekamMedis)).child(getString(R.string.RumahSakit)).child(StringFunction.DeleteDotFromString(final_penyedia_layanan));
                                        ...
                                        reference1.addListenerForSingleValueEvent(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                ...
                                                if (lanjut){ //Nomor Rekam Medis ditemukan di database
                                                    Intent goToVerifikasiPasienLama = new Intent(getApplicationContext(),VerifikasiPasienLamaFLF.class);
                                                    ...
                                                    goToVerifikasiPasienLama.putExtra(getString(R.string.PenyediaLayanan),final_penyedia_layanan);
                                                    goToVerifikasiPasienLama.putExtra(getString(R.string.Kelompok),FinalKelompok);
                                                    goToVerifikasiPasienLama.putExtra(getString(R.string.Layanan),FinalLayanan);
                ...
                CVPasienBaru.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        ETTTL.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                DatePickerDialog datePickerDialog = new DatePickerDialog(VerifikasiPasienFromLayananFragment.this, new DatePickerDialog.OnDateSetListener() {
                                ...
                                reference1.addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        ...
                                        if (!ETNamaPasienBaru.getText().toString().isEmpty() && !ETNIK.getText().toString().isEmpty() && !ETAlamat.getText().toString().isEmpty() && lanjut){
                                            final Intent goToPilihJadwal = new Intent(getApplicationContext(),PilihJadwalPBFLF.class);
                                            ...
                                            reference2.addListenerForSingleValueEvent(new ValueEventListener() {
                                                ...
                                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                    ...
                                                    goToPilihJadwal.putExtra(getString(R.string.PenyediaLayanan),final_penyedia_layanan);
                                                    goToPilihJadwal.putExtra(getString(R.string.Layanan),FinalLayanan);
                                                    goToPilihJadwal.putExtra(getString(R.string.Kelompok),FinalKelompok);
