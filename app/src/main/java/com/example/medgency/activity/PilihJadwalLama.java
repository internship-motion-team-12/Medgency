...
public class PilihJadwalLama extends AppCompatActivity {
    String email_key = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pilih_jadwal_lama);
        ...
        RLTanggalBerobat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(PilihJadwalLama.this, new DatePickerDialog.OnDateSetListener() {
        ...
        BtnToTiketReservasi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                getUsernameLocal();
                final Intent goToTicketReservation = new Intent(getApplicationContext(),TiketResrvasiLama.class);
